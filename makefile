...
migrateup1:
	migrate -path  db/migration -database "postgresql://root:asd123@localhost:8080/simple_bank?sslmode=disable" -verbose up 1

migratedown1:
	migrate -path  db/migration -database "postgresql://root:asd123@localhost:8080/simple_bank?sslmode=disable" -verbose down 1
